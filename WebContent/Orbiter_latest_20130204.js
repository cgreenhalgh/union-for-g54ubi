...
net.user1.orbiter.Product.clientVersion  = new net.user1.orbiter.VersionNumber(2,0,1,817);
...
net.user1.orbiter.HTTPIFrameConnection.prototype.postToIFrame = function (cmd, data) {
  if (this.iframe && this.iFrameReady) {
    ...
    this.iframe.contentWindow.postMessage(cmd + "," + data, this.url);
  }  
}
